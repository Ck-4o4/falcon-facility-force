        ...
        <div className="flex overflow-hidden">
          ...
          >
            {doubled.map((client, i) => (
              ...
              >
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden flex items-center justify-center bg-gray-50 border border-border shadow-sm group-hover:shadow-md transition-shadow duration-300 mb-4">
                  <img
                    src={client.logo}
                    alt={client.name}
      ...
      <div className="container mx-auto px-4 md:px-6 mt-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-border">
          {clients.map((client, i) => (
            ...
            >
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border border-border shadow-sm group-hover:shadow-lg transition-all duration-300 group-hover:scale-110">
                <img
                  src={client.logo}
                  alt={client.name}
                  className="w-full h-full object-cover"
